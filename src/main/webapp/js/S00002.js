...
var Util = {
  ...
  addMenu: function() {
    ...
    var _layer$ = $(''
      ...
      + '        <p>HOME</p>'
      + '        <img alt="HOME" class="right_arrow" src="../../image/right_arrow.png" />'
      + '      </a>'
      + '    </li>'
      + '    <li>'
      + '      <a href="/web/ja/S00005.jsp">'
      + '        <p>作品検索</p>'
      + '        <img alt="作品検索" class="right_arrow" src="../../image/right_arrow.png" />'
      + '      </a>'
      + '    </li>'
      + '    <li>'
      + '      <a href="/web/ja/S00007.jsp">'
      + '        <p>作曲家検索</p>'
      + '        <img alt="作曲家検索" class="right_arrow" src="../../image/right_arrow.png" />'
      + '      </a>'
      + '    </li>'
      + '    <li>'
      + '      <a href="/web/ja/S00009.jsp">'
      + '        <p>専用アプリダウンロード</p>'
      + '        <img alt="専用アプリダウンロード" class="right_arrow" src="../../image/right_arrow.png" />'
      + '      </a>'
      + '    </li>'
      + '    <li>'
      + '      <a href="https://excd.jp/">'
      + '        <p class="to_excd">運営会社</p>'
      + '        <img alt="運営会社「" class="return.png" src="../../image/return.png" />'
      + '      </a>'
      + '    </li>'
      + '  </ul>'
      + '</div>'
